    ...
    def record_vote(self, obj, user, vote):
        ...
        try:
            ...
            if vote == 0:
                ...
                v.vote = vote
                v.save()
                if obj == "post" and v.objects.get_score() <= -2:
                    from django.core import mail
                    mail.send_mail("A topic has been collapsed",
                       'message',
                       'admin@classicmotorsports.net', # from
                       ['admin@classicmotorsports.net'], #to - must be array
                       fail_silently = False
                    )
